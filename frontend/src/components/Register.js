  ...
  return (
    <div id="registerDiv">
      <Grid
        ...
        justify="center"
      >
        <h4 id="inner-title">PLEASE REGISTER</h4>
        <br />
        <TextField
          margin="dense"
          variant="outlined"
        ...
        />
        <span id="registerEmailResult" style={{ color: emailErrorColor }}>
          {emailError}
        </span>
        <br />
        <TextField
        ...
        />
        <span id="registerPasswordResult" style={{ color: passwordErrorColor }}>
          {passwordError}
        </span>
        <br />
        <Button
          disabled={checkEmailError || checkPasswordError ? true : false}
          ...
          type="submit"
          id="registerButton"
          className={buttonStyle.formAccept}
        ...
        <Button
          ...
          type="submit"
          id="loginButton"
          className={buttonStyle.formDecline}
          value="Login"
          onClick={() => {
            history.push("/");
          }}
        ...
        <br />
        <span id="registrationResult" style={{ color: messageColor }}>
          {<h1>{message}</h1>}
        </span>
        <br />
      </Grid>
