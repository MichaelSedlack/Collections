...
function UpdateRoom()
{
    ...
    return(
        <div>
            <Button variant="contained" size="large" color="primary" type="submit" id="updateRoom" className="buttons" value = "Update Room" onClick={()=>{updateRoom}}>Update Room</Button><br />
