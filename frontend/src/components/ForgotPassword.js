      ...
      return (
        <div id="forgotPasswordDiv">
          <Grid container spacing={0} direction="column" alignItems="center" justify="center">
            ...
            <Button disabled style={{marginBottom: "2em"}} variant="contained" size="small" color="primary" type="submit" id="sendEmailButton" className="buttons" value="Send Email" onClick={sendEmail} endIcon={<SendIcon>send</SendIcon>}>Send Email</Button>
